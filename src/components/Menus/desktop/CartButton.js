...
export default function CartButton() {
  ...
  return (
    <div className="flex mx-2 items-center justify-center rounded-lg p-2 border-[1px] border-[#202d2a] border-solid h-full relative">
      <div
        onClick={() => setOpen(!open)}
        className="cursor-pointer transition-all delay-[5ms] hover:opacity-70"
      >
